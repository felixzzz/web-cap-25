...
export default function DownloadItemPublication({
  category,
  created_at,
  deleted_at,
  document_file_en,
  ...
  return (
    ...
    >
      ...
      <div className="mt-2 flex flex-row gap-x-10 lg:mt-0">
        <div
          className={cn(
            "flex flex-row gap-x-3 lg:my-auto lg:ml-auto lg:mr-0 lg:mt-3 lg:gap-x-10"
          )}
        >
          <Image
            className="hidden lg:block"
            src={isPdfFile ? iconPdf : iconRar}
            alt=""
          />
          {isPdfFile && (
            <Link
          ...
          <Button
            variant={"link"}
            className="block h-auto p-0 text-sm font-bold text-primary lg:hidden"
            onClick={handleAddFile}
          >
            Download
          </Button>
          <div className="hidden grid-cols-2 gap-x-3 lg:grid">
            {isPdfFile && (
              <Button
            ...
            >
              <div className="flex gap-x-2">
                <Image
                  ...
                  src={isFileAlreadyAdded() ? iconChecklist : iconPlus}
                  alt=""
                />
                Download
              </div>
...
export const DownloadItemPublicationSkeleton = () => {
  return (
