  ...
  return (
    ...
    >
      ...
      <div className="mt-2 flex flex-row lg:mt-0 gap-x-10">
        {isHaveCheckbox && (
          <div className="my-auto mr-auto flex flex-row lg:ml-auto gap-x-3">
            <div className="flex items-center rounded-full border px-2 py-1 lg:h-[35px] gap-x-2">
              <Checkbox
                id={`english-${id}`}
        ...
        >
          ...
          <Button
            variant={"link"}
            className="ml-3 block h-auto p-0 text-sm font-bold text-primary lg:hidden"
