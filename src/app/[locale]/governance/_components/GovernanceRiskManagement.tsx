...
import { MetaGovernanceRiskManagement } from "@/lib/fragment"
    ...
    <section className="container py-8 lg:py-20">
      <div className="flex flex-col lg:flex-row">
        ...
        <div className="my-auto w-full lg:w-5/12">
          <Anim>
            <AspectRatio ratio={16 / 9} className="my-auto mb-4 mt-4 lg:mt-0">
              <Image
                src={assetUrl(image_id) || ""}
                alt="img-corporate"
                fill
                className="my-auto rounded-3xl object-cover"
              />
            </AspectRatio>
          </Anim>
        </div>
