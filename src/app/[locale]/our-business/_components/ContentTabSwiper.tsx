            ...
            <div className="container">
              <div className="flex flex-col items-center justify-center gap-y-6 lg:flex-row lg:gap-x-24 lg:gap-y-0">
                ...
                <div className="flex-1">
                  ...
                  <div
                    className="prose max-w-none [&_h2]:mb-4 [&_p]:mb-4 [&_ul]:grid [&_ul]:grid-cols-1 [&_ul]:list-disc [&_ul]:ml-4 [&_ul_li::marker]:text-[#53C3D9] [&_ol]:grid [&_ol]:grid-cols-1 [&_ol]:list-decimal [&_ol]:ml-4"
