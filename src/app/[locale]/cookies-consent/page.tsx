...
export async function generateMetadata({
  ...
  const data = await getPage("cookies-consent")
  return {
    alternates: getAlternates(locale, "/cookies-consent"),
...
export default async function CookiesConsentPage() {
  const data: HttpGeneralResponse<{ cookies_content: MetaContentBlock }> =
